...
function GetUserFolder:String;
begin                        //C:\Users\34667\AppData\Local
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Publicador\');
  Result := GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Publicador\';
end;

function GetLogFolder:String;
begin
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+
                                                      '\Publicador\log\archive\');
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Publicador\log\');
  Result := GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Publicador\log\';
end;
